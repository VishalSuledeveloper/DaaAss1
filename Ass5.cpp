...
using namespace std;
#define INF 9999999
//#define V 10 // number of vertices in graph
int main()
{
cout<<"\n\t\tPractical Name: Implementation prims algorithm ( using disjoint set) to find the minimum cost) \n\n";
int V;
cout << "Maximum matrix/no of vertices you have to use in your program: ";
cin >> V;
cout << "\n\t\t\t\tMaximum matrix: " << V << " * " << V << " matrix" << endl;
...
// memset function converts the value of character to unsigned character and copies it into
// each of first n character of object pointed by given string
...
cout << " Minimum cost of path is: " << minimum_CostPath;
return 0;
}